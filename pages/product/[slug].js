  ...
  return (
    ...
    <div className="container px-5 py-24 mx-auto">
      <div className="lg:w-4/5 mx-auto flex flex-wrap">
        <img alt="ecommerce" className="lg:w-1/2  lg:h-auto h-52 object-cover object-top rounded" src="https://m.media-amazon.com/images/I/71A8-ADYzwL._AC_UL320_.jpg"/>
        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
          ...
          <div className="flex">
            ...
            <button onClick={()=>{addToCart(slug, 1,499,'wear the code' , 'XL' , 'Red')}} className="flex ml-auto text-white bg-pink-500 border-0 py-2 px-6 focus:outline-none hover:bg-pink-600 rounded">Add to Cart</button>
